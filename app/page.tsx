...
import DemoGif from '@/images/logos/landingPage/demo.gif';
        ...
        <div className="py-12 sm:py-20 lg:pb-40">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <div className="mt-16 flow-root sm:mt-24">
              <div className="--2 rounded-xl bg-gray-908/5 p-2 ring-1 ring-inset Oring-gray-988/10 g:--4 lg:rounded-2x1 1g:p-4">
                <Image
                  unoptimized
                  src={DemoGif}
                  alt="App screenshot"
