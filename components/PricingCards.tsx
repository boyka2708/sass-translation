...
const tiers = [
  ...
  },
  {
    ...
    href: '#',
    priceMonthly: '₹499',
    description: 'Unlock Full Features Of Pro!',
    features: [
        ...
        {tiers.map((tier) => (
          <div
            ...
            className="flex flex-col justify-between rounded-3xl bg-white p-8 shadow-xl
               ring-1 ring-gray900/10 sm:p-10"
          >
            <div>
              <h3
              ...
              <div className="mt-4 flex items-baseline gap-x-2">
                {tier.priceMonthly ? (
                  ...
                  <span className="text-5xl font-bold tracking-light text-gray-600">
                    Free
                  </span>
                )}
              </div>
